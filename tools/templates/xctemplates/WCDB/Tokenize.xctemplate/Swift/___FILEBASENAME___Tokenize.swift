...
public class ___VARIABLE_productName___TokenizerInfo: TokenizerInfoBase {
    ...
    public required init(withArgc argc: Int32,
                         andArgv argv: UnsafePointer<UnsafePointer<Int8>?>?) {
...
public class ___VARIABLE_productName___Module: Module {
    ...
    public private(set) static var module =
        sqlite3_tokenizer_module(
            iVersion: 0,
            xCreate: { (argc, argv, ppTokenizer) -> Int32 in
                return ___VARIABLE_productName___Module.create(argc: argc,
                                                               argv: argv,
            ...
            xOpen: { (pTokenizer, pInput, nBytes, ppCursor) -> Int32 in
                return ___VARIABLE_productName___Module.open(pTokenizer: pTokenizer,
                                                             pInput: pInput,
                                                             nBytes: nBytes,
                                                             ppCursor: ppCursor)
            },
            ...
            xNext: { (pCursor, ppToken, pnBytes, piStartOffset, piEndOffset, piPosition) -> Int32 in
                return ___VARIABLE_productName___Module.next(pCursor: pCursor,
                                                             ppToken: ppToken,
                                                             pnBytes: pnBytes,
