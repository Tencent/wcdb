...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    public long insertWithOnConflict(String table, String nullColumnHack,
        ...
        switch (conflictAlgorithm) {
            case CONFLICT_NONE: break;
            case CONFLICT_ROLLBACK: insert.orRollback(); break;
            case CONFLICT_ABORT: insert.orAbort(); break;
            case CONFLICT_FAIL: insert.orFail(); break;
            case CONFLICT_IGNORE: insert.orIgnore(); break;
