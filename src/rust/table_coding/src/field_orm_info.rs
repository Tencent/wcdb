...
pub static FIELD_ORM_INFO_MAP: Lazy<HashMap<String, FieldORMInfo>> = Lazy::new(|| {
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Integer", true, "bind_bool_opt", "get_bool_opt"),
    );
    all_info.insert(
        "i8".to_string(),
    ...
    all_info.insert(
        "Option<i8>".to_string(),
        FieldORMInfo::new("Integer", true, "bind_i8_opt", "get_i8_opt"),
    );
    all_info.insert(
        "i16".to_string(),
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Integer", true, "bind_i16_opt", "get_i16_opt"),
    );
    all_info.insert(
        "i32".to_string(),
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Integer", true, "bind_i32_opt", "get_i32_opt"),
    );
    all_info.insert(
        "i64".to_string(),
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Integer", true, "bind_i64_opt", "get_i64_opt"),
    );
    all_info.insert(
        "f32".to_string(),
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Float", true, "bind_f32_opt", "get_f32_opt"),
    );
    all_info.insert(
        "f64".to_string(),
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Float", true, "bind_f64_opt", "get_f64_opt"),
    );
    all_info.insert(
        "String".to_string(),
    ...
    all_info.insert(
        ...
        FieldORMInfo::new("Text", true, "bind_text_opt", "get_text_opt"),
    );
    all_info
});
