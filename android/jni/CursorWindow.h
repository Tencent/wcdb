...
namespace wcdb {
    ...
    public:
        ...
        status_t putBlob(RowSlot *row, uint32_t column, const void* value, size_t size);
        inline status_t putBlob(uint32_t row, uint32_t column, const void* value, size_t size) {
            return putBlob(getRowSlot(row), column, value, size);
        }

        status_t putString(RowSlot *row, uint32_t column, const char* value, size_t sizeIncludingNull);
        inline status_t putString(uint32_t row, uint32_t column, const char* value, size_t sizeIncludingNull) {
    ...
    private:
        ...
        status_t putBlobOrString(RowSlot *row, uint32_t column,
