...
Pod::Spec.new do |wcdb|
  ...
  wcdb.exclude_files = "src/objc/core/WCTOperationQueue.mm", "src/common/core/operate/OperationQueueForMemory.cpp", "src/cpp/platform/**/*.{swift,h,hpp,c,cpp,m,mm}", "src/cpp/tests/**/*.{swift,h,hpp,c,cpp,m,mm}", "src/objc/tests/**/*.{swift,h,hpp,c,cpp,m,mm}", "src/swift/tests/**/*.{swift,h,hpp,c,cpp,m,mm}", "src/bridge/tests/**/*.{swift,h,hpp,c,cpp,m,mm}"
